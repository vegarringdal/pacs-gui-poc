...
export function ProgressFilterSidebar() {
  ...
  return (
    <div className="fixed left-0 z-[9999] bg-gray-800 bottom-0 top-0 drop-shadow-2xl  border-r-2  border-gray-600">
      <div className="text-2xl bg-gray-900 w-full flex p-2 ">
        ...
        <svg
          ...
          strokeWidth={2}
          stroke="currentColor"
          className="w-8 h-8 right-2 absolute text-indigo-700"
          onClick={() => {
